...
const MyTextInput = ({ label, ...props }) => {
  ...
  return (
    <>
      ...
      <input
        className="text-input w-[250px] h-7 border rounded-sm 
        bg-gray-100
  ...
  return (
    <div>
      ...
      <select
        {...field}
        {...props}
        className="flex w-[250px] h-7 border rounded-sm  bg-gray-100"
      />
      {meta.touched && meta.error ? (
        <div className="error absolute mt-[1px]">{meta.error}</div>
      ) : null}
    ...
    <>
      ...
      >
        <>
          ...
          <div
            // white window
            className={`${zIndex} absolute px-14 pt-14 pb-14 rounded-lg
